...
uint8_t I2C_Master_BufferWrite(I2C_TypeDef * I2Cx, uint8_t* pBuffer, uint32_t NumByteToWrite, uint8_t SlaveAddress,uint8_t wordAddress)
{
    if(NumByteToWrite==0)
        return 1;
    /* 1.??*/
...
{
		int t;
		I2C_Master_BufferWrite(	I2C1,IICWriteBuf,11,0xA0,0);
		delay_ms(100);
